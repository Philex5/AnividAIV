...
interface OCMakerPageClientProps {
  ...
  return (
    <div className="min-h-full bg-transparent">
      ...
      <MarketingIntroduction
        title={pageData.Introduce?.title || "OC Maker"}
        description={pageData.Introduce?.description || ""}
        tagline={pageData.Introduce?.tagline || "AI-Powered Character Creation"}
      />

      <MarketingBenefits
        title={pageData.benefits?.section_title || "Why Choose Our OC Maker?"}
        subtitle={
          pageData.benefits?.section_subtitle ||
          "Experience the future of character creation with powerful AI capabilities designed for creators"
        }
        benefits={[
          {
      ...
      <OCMakerUsagePaths
        title={pageData.how_to_use?.title || "Give Form to Your Fantasy"}
        subtitle={
          pageData.how_to_use?.subtitle ||
          "Two paths to bring your characters to life"
        }
        pathA={{
          title: pageData.how_to_use?.path_a?.title || "Path A: Quick Summon",
          description: pageData.how_to_use?.path_a?.description || "",
          steps: pageData.how_to_use?.path_a?.steps || [],
        }}
        pathB={{
          title: pageData.how_to_use?.path_b?.title || "Path B: Master Smith",
          description: pageData.how_to_use?.path_b?.description || "",
          steps: pageData.how_to_use?.path_b?.steps || [],
        }}
      />

      <FeatureRecommend currentSlug="oc-maker" />
      ...
      <MarketingCTA
        title={pageData.call_to_action?.title || "Ready to Create Your OC"}
        description={
          pageData.call_to_action?.description ||
          "Join millions of creators and realize your character creation dreams"
        }
        buttonText={
