...
2. **Model Layer**: `models/user.ts` provides functions like `findUserByEmail`, `insertUser`, all database operations must in this layer.
...
│ │ ├── changelog.md # 开发日志
│ │ └── decisions.md # 技术决策记录
│ │ |—— database-maintenance-guide.md # 数据库维护指南
├── tests/
